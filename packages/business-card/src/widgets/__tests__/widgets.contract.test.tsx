...
import businessCardFixture from '../../__fixtures__/businessCard.json';

const fixtures: Record<string, unknown> = {
  businessCard: businessCardFixture,
};

describe('business-card remote widget contract', () => {
  ...
  it.each(Object.keys(widgets))('renders "%s" with its fixture at both sizes', widgetId => {
    ...
    const renderers = renderWidget(widgets[widgetId], fixture as never, {
      config: { widgetId, applicationName: 'business-card' },
    });
