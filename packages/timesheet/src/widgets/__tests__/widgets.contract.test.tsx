...
import timesheetFixture from '../../__fixtures__/timesheet.json';

const fixtures: Record<string, unknown> = {
  timesheet: timesheetFixture,
};

describe('timesheet remote widget contract', () => {
  ...
  it.each(Object.keys(widgets))('renders "%s" with its fixture at both sizes', widgetId => {
    ...
    const renderers = renderWidget(widgets[widgetId], fixture as never, {
      config: { widgetId, applicationName: 'timesheet' },
    });
